...
.ctrl_data.control_0_bits.lane_count = 2,
		...
		.interrupt_cfg.short_packet_enable_mask = (R_MIPI_CSI_GSIE_GOVE_Msk
				| 0x0),
...
const capture_cfg_t g_vin0_cfg = { .x_capture_start_pixel = 0xFFFF, // Not used. See instance extended configuration
...
/* Instance structure to use this module. */
const capture_instance_t g_vin0 = { .p_ctrl = &g_vin0_ctrl,
		.p_cfg = &g_vin0_cfg, .p_api = &g_capture_on_vin };
