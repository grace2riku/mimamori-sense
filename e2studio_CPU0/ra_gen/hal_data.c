...
const timer_cfg_t g_timer_audio_clk_cfg = { .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.000001952 seconds. Actual duty: 50%. */.period_counts =
		(uint32_t) 0x1e8, .duty_cycle_counts = 0xf4, .source_div =
...
/** If NULL then do not add & */
    ...
    .p_context           = NULL,
		...
		.p_context = (void*) &NULL,
#endif
		.p_extend = &g_timer_audio_clk_extend, .cycle_end_ipl =
				(BSP_IRQ_DISABLED),
...
const timer_instance_t g_timer_audio_clk = { .p_ctrl = &g_timer_audio_clk_ctrl,
		.p_cfg = &g_timer_audio_clk_cfg, .p_api = &g_timer_on_gpt };
