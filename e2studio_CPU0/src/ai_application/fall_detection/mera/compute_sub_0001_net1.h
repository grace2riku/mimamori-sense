...
/*
 kBufferSize_sub_0001_net1 is a compile-time constant to be used by the user of compute_sub_0001_net1 function
 ...
 Example of how to call the compute function:
   ...
   uint8_t my_buffer[kBufferSize_sub_0001_net1];

   int main() {
     ...
     compute_sub_0001_net1(my_buffer, input, output);
   }
*/
enum BufferSize_sub_0001_net1 {

#if defined(ARM_MATH_MVEI)
  kBufferSize_sub_0001_net1 = 9
