...
const TensorInfo sub_0000_net1_tensors[] = {
  { "_split_1_command_stream", 2, 12624, "COMMAND_STREAM", 0xffffffff },
  { "_split_1_flash", 3, 433760, "MODEL", 0xffffffff },
  ...
  { "StatefulPartitionedCall_1_70338", 1, 2592, "OUTPUT_TENSOR", 0x5580 },
  { "StatefulPartitionedCall_0_70327", 0, 648, "OUTPUT_TENSOR", 0xd80 },
};
...
const uint32_t sub_0000_net1_address_StatefulPartitionedCall_1_70338 = 0x5580;
const uint32_t sub_0000_net1_address_StatefulPartitionedCall_0_70327 = 0xd80;
