"""Verify Issue206 ISR wrapping, CPU0 S-record and the known CPU1 pair."""
...
def verify(run):
    ...
    out = (ROOT / 'e2studio_CPU0/Debug/issue206' / run).resolve()
    assert out.is_relative_to((ROOT / 'e2studio_CPU0/Debug/issue206').resolve())
