"""Verify Issue214 CPU0 S-record against ELF and package the known CPU1 pair."""
...
def verify(run):
    out = (ROOT / 'e2studio_CPU0/Debug/issue214' / run).resolve()
    assert out.is_relative_to((ROOT / 'e2studio_CPU0/Debug/issue214').resolve())
